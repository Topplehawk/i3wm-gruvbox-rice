...
alias hl2="wine /home/ryan/Downloads/Valve/'Half-Life 2'/hl2.exe"
alias temp='sensors'
alias ultrascan='cd ultra_scan && ./ultra_scan.sh'
alias gondor="sshpass -p 'Han shot first!' ssh ryan@10.10.10.201"
alias shire="sshpass -p 'Han shot first!' ssh ryan@10.10.10.25"
alias dimfix='sudo brightnessctl s 77000'
alias vim='nvim'
alias pipes='pipes.sh -c 4 -c 7 -r -t 2'
alias cmatrix='cmatrix -C blue -b'
alias sauron='sshpass -p '1234' ssh \
